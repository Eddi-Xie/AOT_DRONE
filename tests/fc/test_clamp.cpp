...
void test_clamp_target_coord_inside_range_passthrough() {
    ...
    TEST_ASSERT(clamp_target_coord(0.0) == 0.0);
    TEST_ASSERT(clamp_target_coord(0.5) == 0.5);
    TEST_ASSERT(clamp_target_coord(-0.5) == -0.5);
    TEST_ASSERT(clamp_target_coord(1.0) == 1.0);
    TEST_ASSERT(clamp_target_coord(-1.0) == -1.0);
}
...
void test_clamp_target_coord_saturates_outside_range() {
    ...
    TEST_ASSERT(clamp_target_coord(1.5) == 1.0);
    TEST_ASSERT(clamp_target_coord(-1.5) == -1.0);
    TEST_ASSERT(clamp_target_coord(1e9) == 1.0);
    TEST_ASSERT(clamp_target_coord(-1e9) == -1.0);
}
...
void test_clamp_target_coord_non_finite_returns_zero() {
    ...
    TEST_ASSERT(clamp_target_coord(nan_v) == 0.0);
    TEST_ASSERT(clamp_target_coord(inf_v) == 0.0);
    TEST_ASSERT(clamp_target_coord(-inf_v) == 0.0);
}
...
void test_clamp_unit_inside_range_passthrough() {
    ...
    TEST_ASSERT(clamp_unit(0.0) == 0.0);
    TEST_ASSERT(clamp_unit(0.25) == 0.25);
    TEST_ASSERT(clamp_unit(0.5) == 0.5);
    TEST_ASSERT(clamp_unit(0.75) == 0.75);
    TEST_ASSERT(clamp_unit(1.0) == 1.0);
}
...
void test_clamp_unit_saturates_outside_range() {
    ...
    TEST_ASSERT(clamp_unit(-0.1) == 0.0);
    TEST_ASSERT(clamp_unit(-1e9) == 0.0);
    TEST_ASSERT(clamp_unit(1.5) == 1.0);
    TEST_ASSERT(clamp_unit(1e9) == 1.0);
}
...
void test_clamp_unit_non_finite_returns_zero() {
    ...
    TEST_ASSERT(clamp_unit(nan_v) == 0.0);
    TEST_ASSERT(clamp_unit(inf_v) == 0.0);
    TEST_ASSERT(clamp_unit(-inf_v) == 0.0);
}
